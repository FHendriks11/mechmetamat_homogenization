...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[])
{
	...
	int i, j;
	double W, F[4], P[4], D[4][4], matconst[8];																	// use total Lagrangian formulation casted in F and P
	int (*getWPD)(const double matconst[8], const double F[4], double &Wd, double P[4], double D[4][4]) = NULL; // pointer to constitutive law functions
